 ...
 * lo unico que se persiste (ver SuperadminRefreshToken). SHA-256 y no
 * bcrypt: el token ya nace con entropia alta (32 bytes de SecureRandom), asi
 * que buscar por igualdad de hash es seguro y permite un WHERE token_hash =
 * ? directo — con bcrypt habria que recorrer cada fila activa.
 */
@Component
