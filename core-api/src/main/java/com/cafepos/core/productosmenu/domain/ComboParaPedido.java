 ...
 * Combo/ComboGrupo completas. codigo se agrega para que com.cafepos.core.caja
 * arme code_reference al transmitir la factura a Factus (ver
 * PedidoItemParaVenta/FacturaDianTransmisionService).
 *
...
public record ComboParaPedido(Integer id, String nombre, BigDecimal precio, String estado,
                               List<ComboGrupoParaPedido> grupos, String codigo) {
}
