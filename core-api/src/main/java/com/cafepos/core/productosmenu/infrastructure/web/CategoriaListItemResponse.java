...
public record CategoriaListItemResponse(Integer id, String icono, String nombre, Integer orden,
                                         long numProductos, String estado) {

    public static CategoriaListItemResponse de(CategoriaResumen resumen) {
        return new CategoriaListItemResponse(resumen.id(), resumen.icono(), resumen.nombre(),
